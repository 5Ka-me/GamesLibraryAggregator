...
// Minimalist line icons (stroke = currentColor) so they follow text color.
...
export const LibraryIcon: React.FC<IconProps> = ({ size = 20 }) => (
  <svg {...base(size)}>
...
export const StoreIcon: React.FC<IconProps> = ({ size = 20 }) => (
  <svg {...base(size)}>
...
export const StatsIcon: React.FC<IconProps> = ({ size = 20 }) => (
  <svg {...base(size)}>
