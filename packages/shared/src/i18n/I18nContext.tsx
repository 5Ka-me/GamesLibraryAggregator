...
const en: Dict = {
  ...
  'stats.periodYearNote': 'Games launched this year — lifetime hours (Steam keeps no per-day history).',
...
const ru: Dict = {
  ...
  'stats.periodYearNote': 'Игры, запускавшиеся в этом году — часы за всё время (Steam не хранит историю по дням).',
